% Compressed Sensing Example of a small section of the Cameraman image
%
%___DESCRIPTION___
...
subplot(1,3,1), imagesc(reshape(x,M,N)), xlabel('Original'), axis image
subplot(1,3,2), imagesc(reshape(x2,M,N)), xlabel('Least Squares'), axis image
subplot(1,3,3), imagesc(reshape(x1,M,N)), xlabel('Basis Pursuit'), axis image
colormap gray